...
public class Candle {
  ...
  public double tax; //This candle object's tax
  ...
  public Candle(int typ, double cst, int brn, double tax) {
    ...
    this.tax = tax; //Stores the fourth user-supplied argument (double) in the tax attribute
  }
  ...
  public String toString() {
    return "Each type " + this.type + " candle costs $" + this.cost +
          "with a tax of $ " + this.tax + " and burns for " + this.burnTime + " minutes";
  }
